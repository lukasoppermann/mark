	...
	if( options.cm.getSelection().length > 0 )
	{
		...
		f = window.setTimeout(function()
		{
			...
			if( typeof(panel) === undefined || panel === null)
			{
				...
				panel.innerHTML = '<div data-class="strong" data-format="strong" class="strong mark-button"><svg viewBox="0 0 30 20" class="mark-icon shape-strong">'+
										...
										+'</svg></div>'+
										'<div data-class="em" data-format="em" class="em mark-button"><svg viewBox="0 0 30 20" class="mark-icon shape-em">'+

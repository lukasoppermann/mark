	...
	if( options.cm.getSelection().length > 0 )
	{
		...
		f = window.setTimeout(function()
		{
			...
			if( typeof(panel) === undefined || panel === null)
			{
				...
				panel.innerHTML = '<div data-class="strong" data-format="strong" class="strong mark-button"><svg viewBox="0 0 20 20" class="mark-icon shape-strong">'+
											'<path d="M8.201,1.032c2.544,0,6.112,0.367,6.112,4.59c0,2.623-1.679,3.462-2.676,3.961 c1.233,0.341,3.279,1.311,3.279,4.328c0,4.381-3.121,5.089-6.505,5.089h-6.19c-0.446,0-0.551-0.105-0.551-0.551v-1.416 c0-0.472,0.105-0.551,0.551-0.551h1.338V3.55H2.221c-0.446,0-0.551-0.079-0.551-0.551V1.583c0-0.472,0.105-0.551,0.551-0.551 H8.201z M7.913,8.455c1.548,0,2.859-0.393,2.859-2.466c0-1.652-1.128-2.203-2.571-2.203H7.1v4.669H7.913z M8.044,16.246 c1.81,0,3.331-0.315,3.331-2.544c0-2.203-1.521-2.492-3.279-2.492H7.1v5.036H8.044z"/>'
										+'</svg></div>'+
										'<div data-class="em" data-format="em" class="em mark-button"><svg viewBox="0 0 20 20" class="mark-icon shape-em">'+
											'<path d="M5.695,16.813c0.057-0.286,0.145-0.665,0.262-1.136l1.266-4.905c0.016-0.074,0.031-0.147,0.043-0.221 c0.012-0.074,0.017-0.142,0.016-0.207C7.272,9.967,6.822,9.278,6.189,9.266l0.113-2.022C6.83,7.194,9.841,6.705,10.324,6.66 c0,0,1.209-0.193,1.081,0.208c-0.128,0.4-1.879,7.608-1.879,7.608c-0.167,0.693-0.28,1.173-0.337,1.441 c-0.043,0.213-0.093,0.346-0.149,0.654c-0.036,0.199,0,0.598,0.556,0.598c0.285-0.007,0.326-0.027,0.915-0.027 c0.57-0.048,0.102,0.944-0.373,1.423c-0.781,0.79-1.626,1.196-2.536,1.218c-0.514,0.012-0.98-0.135-1.397-0.441 c-0.416-0.307-0.632-0.786-0.648-1.438C5.551,17.675,5.597,17.311,5.695,16.813z M11.384,0.548 c0.397,0.378,0.602,0.844,0.615,1.397c0.013,0.553-0.169,1.03-0.547,1.432C11.074,3.779,10.608,3.986,10.056,4c-0.553,0.013-1.03-0.172-1.432-0.555c-0.402-0.383-0.61-0.851-0.623-1.404C7.987,1.489,8.172,1.014,8.555,0.616c0.383-0.397,0.851-0.602,1.404-0.616C10.512-0.012,10.986,0.17,11.384,0.548z"/>'
										+'</svg></div>'+
										'<div data-class="header1" data-format="header" data-parameters=\'{"level":1}\' class="header1 mark-button"><svg viewBox="0 0 30 20" class="mark-icon shape-h1">'+
										...
										+'</svg></div>'+
										'<div data-class="quote" data-format="quote" data-parameters=\'{"level":1}\' class="quote mark-button"><svg viewBox="0 0 30 20" class="mark-icon shape-quote">'+
											'<g><path class="quote-part-1" d="M4.322,7.114C3.113,9.056,2.5,10.908,2.5,12.617c0,1.726,0.466,3.185,1.386,4.336 c0.939,1.176,2.211,1.773,3.78,1.773c1.422,0,2.531-0.441,3.298-1.312c0.756-0.857,1.139-1.853,1.139-2.959 c0-1.229-0.342-2.255-1.017-3.048c-0.688-0.812-1.577-1.224-2.642-1.224c-0.202,0-0.578,0.036-1.184,0.113 c-0.298-0.009-0.452-0.076-0.576-0.208C6.572,9.96,6.52,9.789,6.52,9.554c0-1.012,0.608-2.141,1.808-3.354 c0.702-0.717,1.812-1.623,3.296-2.69l0.256-0.185l-0.882-1.653l-0.315,0.164C7.669,3.398,5.529,5.174,4.322,7.114z"/> <path class="quote-part-2" d="M16.832,7.113c-1.209,1.942-1.822,3.793-1.822,5.503c0,1.726,0.466,3.185,1.386,4.337 c0.939,1.176,2.211,1.773,3.78,1.773c1.421,0,2.531-0.441,3.298-1.312c0.755-0.858,1.139-1.854,1.139-2.959 c0-1.23-0.342-2.256-1.017-3.049c-0.689-0.812-1.578-1.223-2.643-1.223c-0.205,0-0.581,0.036-1.183,0.113 c-0.305-0.009-0.462-0.079-0.584-0.218C19.082,9.96,19.03,9.788,19.03,9.553c0-1.012,0.608-2.14,1.808-3.354 c0.702-0.717,1.812-1.623,3.296-2.69l0.256-0.185l-0.882-1.653l-0.316,0.164C20.18,3.397,18.04,5.173,16.832,7.113z"/></g>'
										+'</svg></div>'+
										'<div data-class="link" data-format="link" class="link mark-button"><svg viewBox="0 0 30 20" class="mark-icon shape-link">'+
										...
										+'</svg></div>'+
										'<div data-class="code" data-format="code" data-parameters=\'{"level":1}\' class="code mark-button"><svg viewBox="0 0 30 20" class="mark-icon shape-code">'+
											'<g><path d="M5.329,2.021c-0.405,0-0.908,0.287-1.118,0.637L0.159,9.422c-0.21,0.35-0.212,0.924-0.004,1.276l3.889,6.585 c0.208,0.351,0.709,0.639,1.114,0.639h1.615c0.405,0,0.577-0.294,0.382-0.652l-3.59-6.602c-0.195-0.359-0.196-0.946-0.001-1.306 l3.615-6.69c0.194-0.359,0.021-0.653-0.384-0.653L5.329,2.021z"/> <path d="M13.361,2.021c0.405,0,0.908,0.287,1.118,0.637l4.052,6.764c0.21,0.35,0.212,0.924,0.004,1.276l-3.889,6.585 c-0.208,0.351-0.709,0.639-1.114,0.639h-1.615c-0.405,0-0.577-0.294-0.382-0.652l3.59-6.602c0.195-0.359,0.196-0.946,0.001-1.306 l-3.615-6.69c-0.194-0.359-0.021-0.653,0.384-0.653L13.361,2.021z"/></g>'
										+'</svg></div>';
				// add panel to editor

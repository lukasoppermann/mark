	...
	if( cm.getSelection().length > 0)
	{
        ...
        panel.innerHTML = panelHtml;
				...
				panel.addEventListener('click', function(e)
				{
					...
					if( e.target.getAttribute('data-format') === 'quote' && ( _(panel).hasClass('quote-1') || _(panel).hasClass('quote-2') ))
					{
						params = '{"level":2}';
					}
					else if( e.target.getAttribute('data-format') === 'code' && ( _(panel).hasClass('code-1') || _(panel).hasClass('code-2')) )
					{
						params = '{"level":2}';
					}
